...
// // --- MOVED OUTSIDE PatientList TO FIX TEXTBOX FOCUS ---

// const HistoryModal = ({ showHistoryModal, patient, history, loading, historyLoading, error, prescriptions, onClose, formattedDate }) => {
...
//                 <h3 className="text-xl font-bold mb-4">Add History – {patient.name}</h3>
//                 <textarea
//                     rows="4"
//                     className="w-full border p-3 rounded"
//                     placeholder="Enter patient history sentence..."
//                     value={historyText}
//                     onChange={(e) => setHistoryText(e.target.value)}
//                 />
//                 <div className="flex justify-end space-x-3 mt-4">
//                     <button onClick={onClose} className="px-4 py-2 bg-gray-200 rounded">Cancel</button>
//                     <button onClick={submitHistory} className="px-4 py-2 bg-green-600 text-white rounded">Save</button>
//                 </div>
//             </div>
//         </div>
//     );
...
//                                     <button onClick={() => fetchPatientHistory(patient)} className="flex items-center space-x-1 text-blue-600 hover:text-blue-700">
//                                         <Pill className="h-4 w-4" /> <span className="text-sm">View Prescription</span>
//                                     </button>
//                                     <button onClick={() => { setSelectedPatient(patient); setShowAddHistory(true); }} className="flex items-center space-x-1 text-green-600 hover:text-green-700">
//                                         <Stethoscope className="h-4 w-4" /> <span>Add History</span>
//                                     </button>
//                                     <button onClick={() => fetchPatientHistory(patient)} className="flex items-center space-x-1 text-purple-600">
...
const PatientList = () => {
    ...
    // In PatientList component, replace the fetchPatientHistory function with:
