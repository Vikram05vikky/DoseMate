...
var Layout = function (_a) {
    ...
    var _b = (0, AppContext_1.useApp)(), user = _b.user, logout = _b.logout;
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <div className="bg-blue-600 p-2 rounded-lg">
                <lucide_react_1.Stethoscope className="h-6 w-6 text-white"/>
              </div>
              <div>
            ...
            {user && (<div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2 bg-gray-100 px-3 py-2 rounded-lg">
                  {user.role === 'admin' ? (<lucide_react_1.Shield className="h-4 w-4 text-blue-600"/>) : (<lucide_react_1.User className="h-4 w-4 text-green-600"/>)}
